...
BOX_TO_SYMBOL = (
    mm.sa.Capability.__name__,
    mm.oa.OperationalCapability.__name__,
    mm.sa.Mission.__name__,
    mm.sa.SystemComponent.__name__,
    "SystemHumanActor",
    "SystemActor",
)
"""
...
def make_box(
    ...
    *,
    ...
    label_getter: cabc.Callable[
        [m.GenericElement], cabc.Iterable[_LabelBuilder]
    ] = lambda i: [
        {
            "text": i.name,
            "icon": (ICON_WIDTH, 0),
...
def is_symbol(obj: str | m.GenericElement | None) -> bool:
