...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            id="OperationalActivity [Make food]",
        ),
        pytest.param(
            ContextInfoBuilder(
            ...
            id="OperationalCapability [Middle]",
        ),
        pytest.param(
            ContextInfoBuilder(
        ...
        pytest.param(
            ...
            id="SystemComponent [Kevin Spacey]",
        ),
        pytest.param(
            ContextInfoBuilder(
