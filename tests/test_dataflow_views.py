...
TEST_DATA_FLOW_SET = [
    pytest.param(
        (TEST_OCAP_UUID, "opcap_data_flow.json", RENDER_PARAMS),
    ...
    pytest.param(
        (TEST_CAP_UUID, "cap_data_flow.json", RENDER_PARAMS),
        id="Capability",
    ),
    pytest.param(
        (
    ...
    pytest.param(
        (TEST_CR_UUID, "cap_realization_data_flow.json", RENDER_PARAMS),
